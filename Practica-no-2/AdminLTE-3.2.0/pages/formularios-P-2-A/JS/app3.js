...
function subir(){
    ...
    contenido.innerHTML = "<h7>ID: "+valorUsuario+"</h7>"+"<br>"+"<h7>Nombre: "+valorNombre+"</h7>"+"<br>"+"<h7>Apellido Paterno: "+valorApaterno+"</h7>"+"<br>"+"<h7>Apellido Materno: "+valorAmaterno+"</h7>"+ "<br>" +"<h7>Email: "+valorEmail+"</h7>"+"<br>"+"<h7>Direccion: "+valorDireccion+"</h7>"+"<br>"+"<h7>RFC: "+valorRfc+"</h7>"+"<br>"+"<h7>Categoria: "+valorCategoria+"</h7>";
